...
prob1<-abs(pnorm(qwe1,mean(qwe1),sd(qwe1))-0.5)*2
plot(prob1, type="l")
...
if(TRUE){
  pkb<-window(pkb,start=c(1999,1))
  cpi<-window(cpi,start=c(1999,1))
  wibor<-window(wibor,start=c(1999,1))
  reer<-window(reer,start=c(1999,1))
}
